...
int main()
{
    ...
    inicializarAlmuerzos(almuerzos, 2000);
    ...
    do
    {
        ...
        case 1:
            ...
            break;
        case 2:
            menuComidas(comidas, LEN_COMIDAS);
            system("pause");
            break;
        case 3:
            altaAlmuerzo(empleados, LEN_EMPLEADOS, sectores,5, menu, LEN_COMIDAS);
            break;
        case 4:
            seguir = 'n';
            break;
