    ...
    do
    {
        ...
        else
        {
            ...
            case 2:
                ...
                break;
            case 3:
                bajaEmpleado(empleados, tamanio);
                system("pause");
                break;
            case 4:
                mostrarEmpleados(empleados, tamanio, sectores, 5);
                system("pause");
                break;
            case 5:
                seguir = 'n';
...
void altaEmpleado(eEmpleado empleados[], int tamanio, eSector sectores[], int tamSector, int indice)
{
    ...
    nuevoEmpleado.fechaIngreso.anio = getValidIntRango("Ingrese anio de ingreso: ", "Error, solo se permiten numeros. Reintente", 1950, 2019);
...
int bajaEmpleado(eEmpleado empleados[], int tamanio)
{
    ...
    {
        int indice;
        indice = buscarEmpleado(empleados, tamanio, legajo);
...
int menu()
{
    ...
    printf("1- Menu  empleado\n");
    printf("2- Menu comidas\n");
