...
int main()
{
    ...
    printf("\nNOMBRE: ");
    setbuf(stdin, NULL); 7 //Igual que fflush pero multiplataforma
    scanf("%[^\n]", (*ptrPer).nombre); //Expresion regular (Puedo poner dos cadenas de caracteres y no se pierde el espacio ej:Juan Pablo)
